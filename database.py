...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        self._peds_to_idx = {neo.designation: idx for idx, neo
                             in enumerate(self._neos)}

        for approach in self._approaches:
            if approach._designation in self._peds_to_idx:
                approach.neo = self._neos[self._peds_to_idx[approach._designation]]
